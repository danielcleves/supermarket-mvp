    ...
    internal class CustomerRepository : BaseRepository, ICustomerRepository
    {
        ...
        public IEnumerable<CustomerModel> GetAll()
        {
            ...
            using (var command = new SqlCommand())
            {
                connection.Open();
                command.Connection = connection;
                command.CommandText = "SELECT * FROM Customers ORDER BY id DESC";
        ...
        public IEnumerable<CustomerModel> GetByValue(string value)
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                command.CommandText = @"SELECT * FROM Customers
                                    WHERE id = @id OR document_number LIKE @value + '%'
        ...
        public CustomerModel GetByDocumentNumber(string documentNumber)
        {
            ...
            using (var command = new SqlCommand())
            {
                connection.Open();
                command.Connection = connection;
                command.CommandText = "SELECT * FROM Customers WHERE document_number = @documentNumber";
                command.Parameters.Add("@documentNumber", SqlDbType.Char).Value = documentNumber;
