    ...
    public partial class CustomerView : Form, ICustomerView
    {
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            BtnNew.Click += delegate
            {
                ...
                tabPageCustomerDetail.Text = "Nuevo Cliente";
            };
            ...
            BtnEdit.Click += delegate
            {
                ...
                tabControl1.TabPages.Remove(tabPageCustomerList);
                tabControl1.TabPages.Add(tabPageCustomerDetail);
                tabPageCustomerDetail.Text = "Editar Cliente";
            };

            // Eliminar cliente
            BtnDelete.Click += delegate
            {
                var result = MessageBox.Show("¿Estás seguro de eliminar el cliente seleccionado?", "Advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        public DateTime? Birthday
        {
            ...
            set { DtpBirthday.Value = value ?? DateTime.Now; } // Manejar el caso de null
        }
