...
namespace Supermarket_mvp.Views
{
    public partial class CategoryView : Form, ICategoryView
    {
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            // Agregar, llama al evento AddNewEvent cuando se haga clic en el botón BtnNew
            BtnNew.Click += delegate
            {
                ...
                tabPageCategoryDetail.Text = "Nueva Categoría"; // Cambia el título de la pestaña
            };
            ...
            BtnEdit.Click += delegate {
                ...
                tabControl1.TabPages.Remove(tabPageCategoryList);
                tabControl1.TabPages.Add(tabPageCategoryDetail);
                tabPageCategoryDetail.Text = "Editar Categoría"; // Cambia el título de la pestaña
            };

            BtnDelete.Click += delegate
            {
                var result = MessageBox.Show("¿Está seguro de que desea eliminar la categoría seleccionada?", "Advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
            ...
            BtnSave.Click += delegate
            {
                ...
                if (isSuccessful) // Si la operación de guardar fue exitosa
                {
                    tabControl1.TabPages.Remove(tabPageCategoryDetail);
